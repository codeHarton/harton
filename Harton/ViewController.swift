...
//        self.navigationController?.pushViewController(vc)
    ...
    private func setupTableView(){
        ...
        Observable.just([Item(name: "MoreThreadViewController", type: MoreThreadViewController.self),Item(name: "RunLoopViewController", type: RunLoopViewController.self),Item(name: "ObjectVc", type: ObjectViewController.self),Item(name: "RuntimeViewController", type: RuntimeViewController.self),Item(name: "TextureLayoutViewController", type: TextureLayoutViewController.self),Item(name: "AlgorithmViewController", type: AlgorithmViewController.self),Item(name: "InterviewViewController", type: InterviewViewController.self),Item(name: "LayoutViewController", type: LayoutViewController.self),Item(name: "OCAutoReleasePoolViewController", type: OCAutoReleasePoolViewController.self),Item(name: "TestViewController", type: TestViewController.self),Item(name: "NatureViewController", type: NatureViewController.self),Item(name: "RXEXTViewController", type: RXEXTViewController.self),Item(name: "Runloop", type: RunLoopViewController.self),Item(name: "响应者链条", type: HitTestViewController.self),Item(name: "多线程", type: ThreadViewController.self),Item(name: "Init", type: InitViewController.self),Item(name: "沙盒", type: SandBoxViewController.self),Item(name: "ISA指针", type: IsaViewController.self),Item(name: "数据库", type: DataBaseViewController.self),Item(name: "AsyncDisplayKit", type: TextureViewController.self),Item(name: "RxSwift", type: RxViewController.self),Item(name: "Promise", type: HUDViewController.self),Item(name: "Lotto", type: BigLottoController.self),Item(name: "lock", type: LockViewController.self)]).bind(to: tableView.rx.items(cellIdentifier: "Cell", cellType: UITableViewCell.self)){ row, ele, cell in
